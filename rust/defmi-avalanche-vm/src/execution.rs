...
//! as the corresponding `defmi` domain type, so statement hashing and
...
struct StandingNotePoolAllocationDto {
    ...
    pq_authorization: Option<zkpi::QuorumApproval>,
}
...
fn participant_mandate_role(role: ReservationRole) -> defmi::participant::MandateRole {
    match role {
        ReservationRole::Maker => defmi::participant::MandateRole::Maker,
        ReservationRole::Taker => defmi::participant::MandateRole::Taker,
    }
}
...
fn release_linked_participant_reservation(
    ...
    state
        ...
        .release_linked_reservation(
            defmi::participant::AutomaticReservationEvidence {
...
fn consume_linked_participant_reservations(
    ...
    for consumption in reservations {
        ...
        let evidence = defmi::participant::AutomaticReservationEvidence {
...
fn grant_credit(
    ...
    defmi::facility::verify_guarantor_signature(
...
mod tests {
    ...
    fn anonymous_reservations_settle_without_post_quote_signatures_and_batch_safely() {
        ...
        let (frost_shares, frost_public) = zkpi::deal_quorum(7, 3, &mut OsRng).unwrap();
    ...
    fn credit_amendment_and_control_require_current_state_and_guarantor_authority() {
        ...
        over_limit.guarantor_signature = defmi::facility::sign_guarantor_message(
            &guarantor_key,
            &zkfmi_crypto::test_support::entity_pq_signer(&guarantor_key.to_bytes()),
            &over_limit
                .guarantor_message()
        ...
        rehabilitate.guarantor_signature = defmi::facility::sign_guarantor_message(
            &guarantor_key,
            &zkfmi_crypto::test_support::entity_pq_signer(&guarantor_key.to_bytes()),
            &rehabilitate
                .guarantor_message()
    ...
    fn settlement_verifier_trust_anchor_has_the_same_native_and_vm_root() {
        ...
        .expect("facility");
        let mut state = State::default();
        let (_, frost_public) = zkpi::deal_quorum(7, 3, &mut OsRng).unwrap();
        let config = SettlementVerifierConfig {
            venue_id: [41; 32],
            defmi_id: [42; 32],
            epoch: 9,
    ...
    fn boj_common_collateral_reservation_and_simultaneous_dvp_are_consensus_atomic() {
        ...
        assert_eq!(
            ...
            defmi::central_bank_liquidity::ReservationStatus::Consumed
        );
