    ...
    match method {
        ...
        "defmivm.crossDomain" => {
            ...
            for record in state.cross_domain.legs.values() {
                match record.status {
                    defmi::cross_domain::LegStatus::Prepared => prepared += 1,
                    defmi::cross_domain::LegStatus::Armed => armed += 1,
                    defmi::cross_domain::LegStatus::Claimed => claimed += 1,
                    defmi::cross_domain::LegStatus::Refunded => refunded += 1,
                }
            }
            Ok(json!({
                "stateRoot": state_root,
        ...
        "defmivm.crossDomainLeg" => {
            ...
            Ok(json!({
                ...
                "status": match record.status {
                    defmi::cross_domain::LegStatus::Prepared => "prepared",
                    defmi::cross_domain::LegStatus::Armed => "armed",
                    defmi::cross_domain::LegStatus::Claimed => "claimed",
                    defmi::cross_domain::LegStatus::Refunded => "refunded",
                },
        ...
        "defmivm.bojLiquidity" => {
            ...
            for participant in state.boj_liquidity.participants.values() {
                match participant.status {
                    defmi::central_bank_liquidity::ParticipantStatus::Active => active += 1,
                    defmi::central_bank_liquidity::ParticipantStatus::CollateralShortfall => {
                        shortfall += 1
                    }
        ...
        "defmivm.bojParticipant" => {
            ...
            Ok(json!({
                ...
                "status": match participant.status {
                    defmi::central_bank_liquidity::ParticipantStatus::Active => "active",
                    defmi::central_bank_liquidity::ParticipantStatus::CollateralShortfall => "collateral_shortfall",
                    defmi::central_bank_liquidity::ParticipantStatus::Overdue => "overdue",
                    defmi::central_bank_liquidity::ParticipantStatus::Suspended => "suspended",
                },
            }))
        }
        "defmivm.bojCollateral" => {
        ...
        "defmivm.participantRegistry" => {
            ...
            for participant in registry.participants.values() {
                match participant.status {
                    defmi::participant::ParticipantStatus::Active => active += 1,
                    defmi::participant::ParticipantStatus::Suspended => suspended += 1,
                    defmi::participant::ParticipantStatus::Revoked => revoked += 1,
                }
            }
            Ok(json!({
                "stateRoot": state_root,
        ...
        "defmivm.participant" => {
            ...
            let purpose_key = |key: &defmi::participant::PurposeKey| {
                json!({
        ...
        "defmivm.bojReservation" => {
            ...
            Ok(json!({
                ...
                "expiresAt": reservation.expires_at,
                "live": reservation.status == defmi::central_bank_liquidity::ReservationStatus::Active
                    && accepted_at < reservation.expires_at,
                "status": match reservation.status {
                    defmi::central_bank_liquidity::ReservationStatus::Active => "active",
                    defmi::central_bank_liquidity::ReservationStatus::Consumed => "consumed",
                    defmi::central_bank_liquidity::ReservationStatus::Released => "released",
                },
