...
use defmi::notes::{NoteLedger, Opening, Wallet};
use zkfmi_zk::pedersen::Pedersen;
use zkfmi_zk::sigma::{prove_opening, verify_linear};
use rand_core::OsRng;
...
fn native_security_regression_legacy_wire_and_changed_output_binding_fail_closed() {
    use defmi::notes::{decode_spend_proof, encode_spend_proof};
...
fn native_security_regression_issuer_signature_binds_the_note_decomposition() {
    ...
    use defmi::notes::note_issuance_body;
