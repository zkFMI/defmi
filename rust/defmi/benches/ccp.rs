...
use defmi::ccp::*;
use defmi::credit::CreditCtx;
use zkfmi_measure::{hosts, time_us, Summary};
...
fn main() {
    let mut rng = OsRng;
    let key = Pedersen::new(b"qomm:defmi:v1").with_value_generator(zkfmi_zk::pedersen::asset_tag(7));
